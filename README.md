# Remote Takeover Framework

This repository will host the source code for the paper:
...
- To improve simulation performance, it is recommended to launch CARLA with a lower quality setting:
